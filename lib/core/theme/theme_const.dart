  ...
  static ThemeData getTheme(){
    return ThemeData(
      ...
      BDMSTextTheme(
        ...
        subTitle: TextStyle(fontFamily: 'Roboto',fontSize: 24, fontWeight: FontWeight.w500), 
        bodyRegular: TextStyle(fontFamily: 'Roboto',fontSize: 17, fontWeight:  FontWeight.w600), 
